    ...
    <section class="text-white mt-18" id="about">
        ...
        <div class="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 z-1">
            ...
            <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full" data-aos="flip-right">
                ...
                <p class="text-base lg:text-lg mt-8 py8">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. 
                    Veritatis voluptatem sequi quod! Id reiciendis in, necessitatibus 
                    repudiandae tenetur facilis suscipit! Dignissimos laborum, explicabo 
                    consequatur nulla iusto, consequuntur dolore natus, esse molestiae quae 
                    commodi veritatis vitae consectetur? Ex reiciendis, libero dolor nostrum 
                    aut error accusantium, incidunt earum fuga aspernatur laboriosam alias?
                </p>
...
<script setup>
    ...
    const education = ref([
        {
            id:1,
            School:'UiTM Terengganu',
            program:'Diploma Computer Science',
            year:'2018 - 2020'
        },
        {
            id:2,
